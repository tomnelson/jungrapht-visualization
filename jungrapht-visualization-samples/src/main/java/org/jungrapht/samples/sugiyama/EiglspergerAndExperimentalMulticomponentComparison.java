...
public class EiglspergerAndExperimentalMulticomponentComparison extends JFrame {

  public EiglspergerAndExperimentalMulticomponentComparison() {
  ...
  public static void main(String[] args) {
    new EiglspergerAndExperimentalMulticomponentComparison();
  }
}
