...
public class MinCrossMulticomponent extends JFrame {
  ...
  public MinCrossMulticomponent() {
    ...
    HierarchicalMinCrossLayoutAlgorithm<String, Integer> layoutAlgorithm1 =
        HierarchicalMinCrossLayoutAlgorithm.<String, Integer>edgeAwareBuilder()
            .postStraighten(true)
            .threaded(false)
    ...
    HierarchicalMinCrossLayoutAlgorithm<String, Integer> layoutAlgorithm2 =
        HierarchicalMinCrossLayoutAlgorithm.<String, Integer>edgeAwareBuilder()
            .postStraighten(true)
            .threaded(false)
            .layering(Layering.COFFMAN_GRAHAM)
