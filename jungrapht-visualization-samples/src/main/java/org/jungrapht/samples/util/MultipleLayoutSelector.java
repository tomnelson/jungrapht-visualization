 ...
 * @param <E> edge type
 */
public class MultipleLayoutSelector<V, E> extends JPanel {

  private static final Logger log = LoggerFactory.getLogger(MultipleLayoutSelector.class);
  ...
  public static class Builder<V, E> {
    ...
    /** @return a configured {@link MultipleLayoutSelector} */
    public MultipleLayoutSelector<V, E> build() {
      return new MultipleLayoutSelector<>(this);
    }
  }
  ...
  private MultipleLayoutSelector(
    ...
    TreeLayoutAlgorithm<V> treeLayoutAlgorithm =
        TreeLayoutAlgorithm.<V>builder().vertexBoundsFunction(this.vertexBoundsFunction).build();
    ...
    ISOMLayoutAlgorithm<V> isomLayoutAlgorithm = new ISOMLayoutAlgorithm<>();
    ...
    JRadioButton isomButton = new JRadioButton("ISOMLayout");
    isomButton.addItemListener(new LayoutItemListener(isomLayoutAlgorithm, vv));
    isomButton.setSelected(initialSelection == layoutNumber++);

    JRadioButton frButton = new JRadioButton("FRLayout");
    frButton.addItemListener(new LayoutItemListener(frLayoutAlgorithm, vv));
    frButton.setSelected(initialSelection == layoutNumber++);

    JRadioButton kkButton = new JRadioButton("KKLayout");
    kkButton.addItemListener(new LayoutItemListener(kkLayoutAlgorithm, vv));
    kkButton.setSelected(initialSelection == layoutNumber++);

    JRadioButton forceAtlas2Button = new JRadioButton("ForceAtlas2Layout");
    forceAtlas2Button.addItemListener(new LayoutItemListener(forceAtlas2LayoutAlgorithm, vv));
    forceAtlas2Button.setSelected(initialSelection == layoutNumber++);
    ...
    layoutRadio.add(isomButton);
    layoutRadio.add(kkButton);
    layoutRadio.add(frButton);
    layoutRadio.add(forceAtlas2Button);
