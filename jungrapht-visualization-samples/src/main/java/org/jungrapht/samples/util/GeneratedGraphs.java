...
public class GeneratedGraphs {
    ...
    public static Map<String, Supplier<Graph<String, Integer>>> map =
            Map.of("BarbarasiAlbert", GeneratedGraphs::getBarbarasiGeneratedGraph,
                    "PlantedPartition", GeneratedGraphs::getPlantedPartitionGeneratedGraph,
                    "StarGraph", GeneratedGraphs::getStarGraphGeneratedGraph,
                    "WheelGraph", GeneratedGraphs::getWheelGraphGeneratedGraph,
                    "Windmill", GeneratedGraphs::getWindmillGraphGeneratedGraph,
                    "DutchWindmill", GeneratedGraphs::getDutchWindmillGraphGeneratedGraph,
                    "WattsStrogatz", GeneratedGraphs::getWattsStrogatzGraphGeneratedGraph,
                    "PruferTree", GeneratedGraphs::getPruferTreeGeneratedGraph,
                    "Complete", GeneratedGraphs::getCompleteGraphGeneratedGraph);

    private static Graph<String, Integer> getGraph(boolean directed) {
        return GraphTypeBuilder.<String, Integer>forGraphType(
                directed ? DefaultGraphType.directedPseudograph() :
    ...
    private static Function<GraphGenerator<String, Integer, String>, Graph<String, Integer>> directed =
            gen -> {
                Graph<String, Integer> graph = getGraph();
                gen.generateGraph(graph, null);
                return graph;
            };
    private static Function<GraphGenerator<String, Integer, String>, Graph<String, Integer>> undirected =
            gen -> {
