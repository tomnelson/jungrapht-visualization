...
import org.jungrapht.visualization.control.EditingDefaultGraphMouse;
...
public class GraphEditorDemoWithPalette2 extends JPanel implements Printable {
  ...
  public GraphEditorDemoWithPalette2() {
    ...
    final EditingDefaultGraphMouse<Integer, Integer> graphMouse =
        EditingDefaultGraphMouse.<Integer, Integer>builder()
    ...
    graphMouse.setMode(ModalGraphMouse.Mode.DEFAULT);
    ...
    JComboBox modeBox = ModeControls.getEditingDefaultModeComboBox(graphMouse);
