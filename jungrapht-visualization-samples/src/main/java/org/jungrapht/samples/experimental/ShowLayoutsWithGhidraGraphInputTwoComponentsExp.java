...
public class ShowLayoutsWithGhidraGraphInputTwoComponentsExp extends JFrame {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(ShowLayoutsWithGhidraGraphInputTwoComponentsExp.class);
  ...
  public ShowLayoutsWithGhidraGraphInputTwoComponentsExp() {
  ...
  private void loadGraphFile(Graph<String, DefaultEdge> graph) {
    ...
    try (InputStreamReader inputStreamReader =
        new InputStreamReader(
            ShowLayoutsWithGhidraGraphInputTwoComponentsExp.class.getResourceAsStream(
                "/" + fileName))) {
      importer.importGraph(graph, inputStreamReader);
    } catch (Exception ex) {
      ex.printStackTrace();
  ...
  public static void main(String[] args) {
    new ShowLayoutsWithGhidraGraphInputTwoComponentsExp();
  }
}
