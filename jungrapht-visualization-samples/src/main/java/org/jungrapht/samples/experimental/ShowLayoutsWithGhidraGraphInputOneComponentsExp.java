...
public class ShowLayoutsWithGhidraGraphInputOneComponentsExp extends JFrame {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(ShowLayoutsWithGhidraGraphInputOneComponentsExp.class);
  ...
  public ShowLayoutsWithGhidraGraphInputOneComponentsExp() {
...
//        ed, Map.of("EdgeType", new DefaultAttribute("Fall-Through", AttributeType.STRING)));
    ...
    layoutComboBox.setSelectedItem(LayoutHelperEiglsperger.Layouts.EIGLSPERGERLP);
  ...
  private void loadGraphFile(Graph<String, DefaultEdge> graph) {
    ...
    try (InputStreamReader inputStreamReader =
        new InputStreamReader(
            ShowLayoutsWithGhidraGraphInputOneComponentsExp.class.getResourceAsStream(
                "/" + fileName))) {
      importer.importGraph(graph, inputStreamReader);
    } catch (Exception ex) {
      ex.printStackTrace();
  ...
  public static void main(String[] args) {
    new ShowLayoutsWithGhidraGraphInputOneComponentsExp();
  }
}
