 ...
 * @author Tom Nelson
 */
public class SpatialLensDemoWithThreeStarVertices extends JPanel {

  private static final Logger log =
      LoggerFactory.getLogger(SpatialLensDemoWithThreeStarVertices.class);
  /** the graph */
  ...
  public SpatialLensDemoWithThreeStarVertices() {
    ...
    graph = buildThreeVertexGraph();

    graphLayoutAlgorithm = new CircleLayoutAlgorithm<>();
    ...
    vv.getRenderContext()
        .setVertexShapeFunction(
            new Function<>() {
              ShapeFactory<String> shapeFactory = new ShapeFactory<>(n -> 100, n -> 1.0f);
  ...
  Graph<String, Integer> buildThreeVertexGraph() {
    Graph<String, Integer> graph =
  ...
  public static void main(String[] args) {
    ...
    f.getContentPane().add(new SpatialLensDemoWithThreeStarVertices());
    f.pack();
    f.setVisible(true);
  }
}
