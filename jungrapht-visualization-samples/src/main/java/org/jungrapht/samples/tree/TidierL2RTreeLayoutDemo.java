  ...
  public TidierL2RTreeLayoutDemo() {
    ...
    vv =
        VisualizationViewer.builder(graph)
            ...
            .build();
    treeLayoutAlgorithm.setVertexShapeFunction(vv.getRenderContext().getVertexBoundsFunction());
    radialLayoutAlgorithm.setVertexShapeFunction(vv.getRenderContext().getVertexBoundsFunction());
