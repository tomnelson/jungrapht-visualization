 ...
 * @author Tom Nelson
 */
public class TreeLayoutDemoOverlapTest extends JPanel {

  private static final Logger log = LoggerFactory.getLogger(TreeLayoutDemoOverlapTest.class);
  Graph<String, Integer> graph;

  /** the visual component and renderer for the graph */
  VisualizationViewer<String, Integer> vv;

  public TreeLayoutDemoOverlapTest() {

    setLayout(new BorderLayout());
    // create a simple graph for the demo
    graph = DemoTreeSupplier.createNonTree();
    int width = 20;
    int height = 20;
  ...
  public static void main(String[] args) {
    ...
    JPanel demo = new TreeLayoutDemoOverlapTest();
    content.add(demo);
    frame.pack();
