 ...
 * @author Tom Nelson
 */
public class TreeLayoutDemoWithIsolatedVertices extends JPanel {

  private static final Logger log =
      LoggerFactory.getLogger(TreeLayoutDemoWithIsolatedVertices.class);
  Graph<String, Integer> graph;

  /** the visual component and renderer for the graph */
  VisualizationViewer<String, Integer> vv;

  public TreeLayoutDemoWithIsolatedVertices() {
  ...
  public static void main(String[] args) {
    ...
    JPanel demo = new TreeLayoutDemoWithIsolatedVertices();
    content.add(demo);
    frame.pack();
