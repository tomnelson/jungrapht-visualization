 ...
 * @author Tom Nelson
 */
public class BrandesKopfSugiyamaGraphExampleWithLayoutsAgain extends JFrame {

  private static final Logger log =
      LoggerFactory.getLogger(BrandesKopfSugiyamaGraphExampleWithLayoutsAgain.class);

  public BrandesKopfSugiyamaGraphExampleWithLayoutsAgain() {
  ...
  public static void main(String[] args) {
    new BrandesKopfSugiyamaGraphExampleWithLayoutsAgain();
  }
}
