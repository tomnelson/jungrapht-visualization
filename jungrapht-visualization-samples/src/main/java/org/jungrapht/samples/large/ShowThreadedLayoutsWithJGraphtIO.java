...
import org.jungrapht.visualization.util.LayoutAlgorithmThreadedTransition;
 ...
 * @author Tom Nelson
 */
public class ShowThreadedLayoutsWithJGraphtIO extends JFrame {

  private static final Logger log = LoggerFactory.getLogger(ShowThreadedLayoutsWithJGraphtIO.class);
  ...
  public ShowThreadedLayoutsWithJGraphtIO() {
            ...
            SwingUtilities.invokeLater(
                () -> {
                  ...
                  if (animateLayoutTransition.isSelected()) {
                    LayoutAlgorithmThreadedTransition.animate(vv, layoutAlgorithm, r);
                  } else {
                    LayoutAlgorithmThreadedTransition.apply(vv, layoutAlgorithm, r);
                  }
                  log.info(
  ...
  public static void main(String[] args) {
    new ShowThreadedLayoutsWithJGraphtIO();
  }
}
