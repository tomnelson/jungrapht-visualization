## JUNGRAPHT-VISUALIZATION: The [JUNG](http://jung.sourceforge.net) visualization and sample code ported to use [JGraphT](https://jgrapht.org) graphs and algorithms
...
The most recent version of JUNGRAPHT-VISUALIZATION is [version 1.0](https://github.com/tomnelson/jungrapht-visualization/releases/tag/jungrapht-visualization-1.0), released 7 August 2019.
