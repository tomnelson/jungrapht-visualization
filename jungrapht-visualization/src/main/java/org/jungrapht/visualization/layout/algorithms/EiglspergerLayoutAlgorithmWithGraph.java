 ...
 * @param <E> edge type
 */
public class EiglspergerLayoutAlgorithmWithGraph<V, E>
  ...
  private static final Logger log =
      LoggerFactory.getLogger(EiglspergerLayoutAlgorithmWithGraph.class);
  ...
  public static class Builder<
          V,
          E,
          T extends EiglspergerLayoutAlgorithmWithGraph<V, E> & EdgeAwareLayoutAlgorithm<V, E>,
    ...
    /** {@inheritDoc} */
    public T build() {
      return (T) new EiglspergerLayoutAlgorithmWithGraph<>(this);
    }
  }
  ...
  public EiglspergerLayoutAlgorithmWithGraph() {
    this(EiglspergerLayoutAlgorithmWithGraph.edgeAwareBuilder());
  }

  protected EiglspergerLayoutAlgorithmWithGraph(Builder builder) {
    this(
  ...
  protected EiglspergerLayoutAlgorithmWithGraph(
