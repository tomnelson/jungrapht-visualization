        ...
        implements BarnesHutRepulsion<V, BarnesHutFA2Repulsion<V>, BarnesHutFA2Repulsion.Builder<V>>
{
    ...
    extends StandardFA2Repulsion.Builder<V, BarnesHutFA2Repulsion<V>, BarnesHutFA2Repulsion.Builder<V>>
    implements BarnesHutRepulsion.Builder<V, BarnesHutFA2Repulsion<V>, BarnesHutFA2Repulsion.Builder<V>>
    {
    ...
    public void calculateRepulsion() {
        for (V vertex : layoutModel.getGraph().vertexSet()) {
            ...
            ForceObject<V> forceObject = new ForceObject<V>(
                    vertex, forcePoint,
                    nodeMasses.get(vertex)
            ) {
                @Override
