...
implements IterativeContext
{
    ...
    // Constants
    private final static double ks = 0.1; // Global speed coefficient
    private final static double ksMax = 10.0; // Global speed maximum coefficient
    private final static double epsilon = 1e-16; // Math stability
    ...
    implements LayoutAlgorithm.Builder<V, T, B>
    {
        ...
        private Function<V, Point> initializer = v -> Point.of(random.nextDouble(), random.nextDouble());

        public B repulsionContract(StandardFA2Repulsion.Builder repulsionContractBuilder) {
         ...
         * Andreas Noack produced an excellent work on placement quality measures.
         * His LinLog energy model arguably provides the most readable placements,
         * since it results in a placement that corresponds to Newman’s modularity,
         * a widely used measure of community structure.
         * The LinLog mode just uses a logarithmic attraction force.
         *
         * Default: false
        ...
        /**
         * Set weights power. Only for AttractionByWeights mode.
         * If the setting “Edge Weight Influence”  is set to 0, the weights are ignored.
         * If it is set to 1, then the attraction is proportional to the weight.
         * Values above 1 emphasize the weight effects.
         *
         * Default: 1.0
         * @see "https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0098679"
         * @param weightsDelta
         ...
         * "Dissuade Hubs" tends to push hubs to the periphery while keeping authorities in the center.
         *
         * Default: false
         * @see "https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0098679"
        ...
        /**
         * Set gravity K.
         * Gravity is a common improvement of force-directed layouts.
         * This force prevents disconnected components (islands) from drifting away.
         * It attracts nodes to the center of the spatialization space.
         * Recommended values 1.0-5.0
         *
         * Default: 2.0
         * @see "https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0098679"
         * @param kg
        ...
        /**
         * Tolerance to swinging. Higher value of tolerance allow higher value of speed.
         * For details see original paper about ForceAtlas2.
         *
         * Default: 1.0
         * @see "https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0098679"
         * @param tolerance
    ...
    public void visit(LayoutModel<V> layoutModel) {
        ...
        repulsionContract = repulsionContractBuilder
    ...
    private void calcAttraction(Object edge) {
        ...
        if (!v1_locked) {
            ...
            frVertexData.put(vertex1, fvd1.add(-force1 * xDelta, -force1 * xDelta));
        }
        if (!v2_locked) {
            Point fvd2 = getFRData(vertex2);
            frVertexData.put(vertex2, fvd2.add(force2 * xDelta, force2 * xDelta));
        }
    }
