...
public class NetworkSimplex<V, E> {
  ...
  public NetworkSimplex(Graph<V, E> dag, Graph<V, E> spanningTree) {
    this.dag = dag;
    this.spanningTree = spanningTree;
  }

  public NetworkSimplex(Graph<V, E> dag) {
  ...
  Set<E> getCrossComponentEdges(Graph<V, E> spanningTree, Pair<Set<V>> headAndTail) {
    return dag.edgeSet()
        .stream()
