 ...
 * @author Tom Nelson
 */
public class FA2LayoutsTest {

  private static final Logger log = LoggerFactory.getLogger(FA2LayoutsTest.class);
  ...
  @Test
  public void testFA2Layouts() {
    ForceAtlas2LayoutAlgorithm layoutAlgorithmOne =
  ...
  @Test
  public void testFA2BHVisitor() {
    ForceAtlas2LayoutAlgorithm layoutAlgorithmThree =
        ForceAtlas2LayoutAlgorithm.builder()
   ...
   */
  @Test
  public void testFA2BHWithThetaZero() {
    ForceAtlas2LayoutAlgorithm layoutAlgorithmFour =
        ForceAtlas2LayoutAlgorithm.builder()
            .repulsionContractBuilder(BarnesHutFA2Repulsion.builder().theta(0))
            .randomSeed(0)
            .build();
    // using the same random seed each time for repeatable results from each test.
